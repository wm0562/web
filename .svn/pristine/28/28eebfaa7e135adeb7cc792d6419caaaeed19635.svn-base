...
public class CloudStaffUserTemp extends UploadTempModel {
	...
	public void setByIndex(int index, String content) throws Exception {
		// 和Excel中列字段顺序对应
		String[] indexFeildName = new String[] { "serialNum", "orgName", "code", "name", "gender", "birthday", "credentialNum", "nationName", "maritalStatusName", "politicalStatusName", "joinWorkTime", "workYearLimit", "isLeave", "leaveTime",
				"workTypeName", "orderIndex", "description", "birthPlace", "presentPlace", "livePlace", "phone", "officeTel", "email", "innerEmail", "graduate", "educationName", "authorizeName", "postName", "partyPostName", "entryHereTime", "idCard",
				"socialSecurityNo", "socialSecuritycase", "outSourcing", "outSourcingComp", "userName" };
