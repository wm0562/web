...
@Transactional
public class CloudUserRoleServiceImpl extends SimplePagingAndSortingService<CloudUserRole, String>
		implements ICloudUserRoleService {
	...
	public void deleteByUserId(String userId) {
		this.cloudUserRoleDao.deleteByUserId(userId);
	}

	@Override
	public void addRolesTenantRoles(String userId, String[] roleIdArr, String[] tenantRoleIdsArr) {
		if (null != roleIdArr) {
			this.addRoles(userId, roleIdArr);
		}
		if (null != tenantRoleIdsArr) {
			tenantUserRoleService.addRoles(userId, tenantRoleIdsArr);
		}
	}
}
