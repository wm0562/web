...
public interface ICloudFunctionDao extends HibernateRepository<CloudFunction, String> {
	...
	/**
	 * @Title: getFunctionsByUserId @Description: 根据用户id获取功能码，功能id @return
	 * List<CloudFunctionAndroidDto> @throws
	 */
	...
	/**
	 * @Title: getTenantFunctionsByUserId @Description:
	 * 根据用户id获取功能码，功能id（不挂在业务系统下） @return List<CloudFunctionAndroidDto> @throws
	 */
