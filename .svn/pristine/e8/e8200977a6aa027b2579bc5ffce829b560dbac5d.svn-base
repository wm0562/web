...
public class CloudStaffTempServiceImpl implements ICloudStaffTempService {
	...
	@Override
	public Map<String, Object> importData(CloudStaffTemp temp, String tenantId, String marks, int row) throws Exception {
		...
		// 验证编码
		if (StringUtils.isNotEmpty(temp.getCode())) {
			if (temp.getCode().length() > STAFF_CODE_MAX_LENGTH) {
		...
		String userId = StringUtils.isEmpty(SpringmvcUtils.getParameter("userId")) ? commonUtilsService.getUserId(request) : SpringmvcUtils.getParameter("userId");
	...
	@Override
	public Map<String, Object> importDataWithParam(CloudStaffTemp tempModel, String tenantId, String marks, int row, Map<String, Object> personalParams) throws Exception {
