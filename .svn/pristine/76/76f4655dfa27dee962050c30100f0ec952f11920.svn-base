...
public class RoleController extends BaseController {
	...
	public RestResultDto<String> loadSystemRoleTree(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			systemRoleGroupTree.reloadSystemRoleTree(StringUtils.isEmpty(SpringmvcUtils.getParameter("tenantId")) ? infoDto.getTenantId() : SpringmvcUtils.getParameter("tenantId"));
