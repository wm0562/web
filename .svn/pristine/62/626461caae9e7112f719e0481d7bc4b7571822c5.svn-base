...
public class ManagementConstant {
	...
	// 集团用户相关
	public static final String USER_NAME_SPLIT = "|~~|"; // 集团子账号的分隔符
	public static final String USER_NAME_SPLIT_REGEX = "\\|~~\\|"; // 分隔符转义
	public static final String ROLE_GROUP_JT = "ROLE_GROUP_JTJS"; // 集团子账号默认角色组code
	public static final String ROLE_JT = "ROLE_JTJS"; // 集团子账号默认角色code
	public static final String DEPT_JT = "DEPT_JT"; // 集团子人员默认机构的code
	// 是否根节点
	...
	public final static String ACCESSTOKEN_HEAD_KEY = "Authorization";
	public final static String ACCESSTOKEN_PARAM_KEY = "access_token";
	// 配置文件中拷贝菜单时，目标management的ip,key
	public static final String COPY_RESOURCE_TARGET_URL = "COPY_RESOURCE_TARGET_URL";
	public static final String PHONE_TID_RESTPASSWORD = "3892274"; // 手机短信模板，发送新密码
	public static final String PHONE_TID_AUTHCODE = "4042315"; // 手机短信模板，发送验证码
}
