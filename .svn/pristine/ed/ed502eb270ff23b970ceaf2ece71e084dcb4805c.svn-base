...
public class CloudStaffSystemUpdateController extends BaseController {
	private Logger logger = LoggerFactory.getLogger(CloudStaffSystemUpdateController.class);
	...
	@FunctionCode(value = "CF_MANAGE_SYSTEM_STAFF_UPDATE", type = ResponseType.Json)
