...
public class CloudUserRoleDaoImpl extends SimpleHibernateRepository<CloudUserRole, String> implements ICloudUserRoleDao {
	...
	public CloudUserRole findByUidAndRid(String userId, String roleId) {
		...
		filterList.add(new SearchFilter("roleId", Operator.EQ, roleId));
		List<CloudUserRole> list = findListByFilter(filterList, null);
	...
	public void deleteByUserId(String userId) {
		String sql = "delete from cloud_user_role where userId='" + userId + "'";
