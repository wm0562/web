...
public class CloudDivisionDaoImpl extends SimpleHibernateRepository<CloudDivision, String> 
implements ICloudDivisionDao {
	...
	/**
	 * 重写。
	 * 实现：nodeCode的写入。nodeCode一级为2个整数位，即一级最多含99个记录。
	 */
	@Override
