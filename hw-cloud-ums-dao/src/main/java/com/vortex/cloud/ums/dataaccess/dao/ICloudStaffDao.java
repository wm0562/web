...
public interface ICloudStaffDao extends HibernateRepository<CloudStaff, String> {
	...
	/**
	 * @Title: getWillManStaffUserList @Description: 获取是意愿者，并有用户的人员 @return
	 *         List<CloudStaffDto> @throws
	 */
	...
	/**
	 * @Title: getWillManStaffUserPage @Description: 获取是意愿者，并有用户的人员 @return
	 *         Page<CloudStaffDto> @throws
	 */
