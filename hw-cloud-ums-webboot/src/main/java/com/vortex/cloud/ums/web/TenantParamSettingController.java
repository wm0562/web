...
public class TenantParamSettingController extends BaseController {
	...
	public RestResultDto<Boolean> save(HttpServletRequest request, TenantPramSetting newparameterSetting) {
		...
		try {
			newparameterSetting.setTenantId(StringUtils.isEmpty(SpringmvcUtils.getParameter("tenantId")) ? super.getLoginInfo(request).getTenantId() : SpringmvcUtils.getParameter("tenantId"));
