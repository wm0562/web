...
public interface ITenantFunctionRoleService extends PagingAndSortingService<TenantFunctionRole, String> {
	 ...
	 * @param functionIdArr
	 */
	void saveFunctionsForRole(String roleId, String[] functionIdArr) ;
